...
export declare class MeasurerScene extends StartEndScene<MeasurerTypeProperties> {
    ...
    readonly background: _Scene.Path;
    ...
    updateAnchor(_datum: MeasurerTypeProperties, coords: _ModuleSupport.Vec4, _context: AnnotationContext, _bbox?: _Scene.BBox): void;
