 ...
 *
 * Version: 16.0.0
 * Release date: 09/07/2025 (built at 09/07/2025 09:58:50)
 */
.ht-theme-horizon,
...
.ht-theme-horizon-dark {
  ...
  --ht-icon-button-active-hover-border-color: #070604;
  --ht-icon-button-active-hover-background-color: rgba(0, 0, 0, 0);
  --ht-icon-button-active-hover-icon-color: #070604;
  --ht-collapse-button-open-border-color: rgba(0, 0, 0, 0);
  --ht-collapse-button-open-background-color: #19191c;
  --ht-collapse-button-open-icon-color: #aeaeae;
  --ht-collapse-button-open-icon-active-color: #b5b5b9;
  --ht-collapse-button-open-hover-border-color: rgba(0, 0, 0, 0);
  --ht-collapse-button-open-hover-background-color: #2d2d30;
  ...
  --ht-collapse-button-close-background-color: #19191c;
  --ht-collapse-button-close-icon-color: #aeaeae;
  --ht-collapse-button-close-icon-active-color: #b5b5b9;
  --ht-collapse-button-close-hover-border-color: rgba(0, 0, 0, 0);
  --ht-collapse-button-close-hover-background-color: #2d2d30;
