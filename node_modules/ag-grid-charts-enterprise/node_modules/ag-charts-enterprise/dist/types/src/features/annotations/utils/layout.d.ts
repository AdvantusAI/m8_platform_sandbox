...
type Vec2Scene = _Scene.Node & {
    x: number;
    y: number;
};
type Vec4Scene = _Scene.Node & {
    x: number;
    y: number;
    x1: number;
    y1: number;
...
export declare function layoutSetX(scene: PositionedScene, x: number): void;
export declare function layoutSetY(scene: PositionedScene, y: number): void;
