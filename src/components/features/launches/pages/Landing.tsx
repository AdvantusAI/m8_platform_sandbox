    ...
    <div className="container mx-auto px-4 py-8">
      ...
      <div className="grid md:grid-cols-3 gap-6">
        <Card>
          ...
          <CardContent>
            <p className="text-sm text-muted-foreground">
              Leverage machine learning to predict demand using analog products and market factors.
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-sm text-muted-foreground">
              Compare optimistic, base, and pessimistic scenarios to make informed decisions.
            </p>
          </CardContent>
        </Card>
        ...
        <Card>
          ...
          <CardContent>
            <p className="text-sm text-muted-foreground">
              Validate launch feasibility with real-time supply chain constraints and lead times.
            </p>
          </CardContent>
        </Card>
      </div>
